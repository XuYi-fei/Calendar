...
class baseMainWindow ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"万年历_version1", pos = wx.DefaultPosition, size = wx.Size( 879,514 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		self.combo_box_year = wx.ComboBox( sbSizer1.GetStaticBox(), wx.ID_ANY, u"1", wx.DefaultPosition, wx.DefaultSize, combo_box_yearChoices, 0 )
		self.combo_box_year.SetSelection( 1 )
		...
		self.menu_exit = wx.MenuItem( self.menu_menu, wx.ID_ANY, u"退出", wx.EmptyString, wx.ITEM_NORMAL )
